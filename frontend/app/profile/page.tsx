        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="md:col-span-2 space-y-4">
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-500">
                    <div className="flex items-center gap-1.5"><MapPin size={14} /><span>東京, 日本</span></div>
                    <div className="flex items-center gap-1.5"><Calendar size={14} /><span>2025年11月から利用中</span></div>
                </div>
            </div>
...
// 投稿一覧エリア
const PostGrid = ({ posts, loading }: { posts: any[], loading: boolean }) => (
    <>
