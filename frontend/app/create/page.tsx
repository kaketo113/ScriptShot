                    ...
                    <div className='w-1/2 border-r border-white/10 flex flex-col bg-[#1e1e1e]'>
                        <div className='flex-1 relative overflow-hidden flex'>
                            ...
                            <div className='flex-1 relative overflow-auto custom-scrollbar'>
                                {/* バッジ */}
                                <div className='absolute top-0 right-4 bg-[#2d2d2d] text-[10px] text-gray-400 px-3 py-1 rounded-b-md z-30 font-mono border-x border-b border-white/5 pointer-events-none'>
                                    HTML / CSS
                                </div>
                                ...
                                <div className='relative min-h-full font-mono text-sm' style={{ minWidth: '100%' }}>
                                    ...
                                    <pre 
                                        aria-hidden="true" 
                                        className='absolute inset-0 m-0 p-4 pt-4 pointer-events-none whitespace-pre-wrap break-all z-0'
