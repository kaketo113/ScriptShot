...
const usePostSearch = () => {
    ...
    const filteredPosts = useMemo(() => {
        ...
        return posts.filter(post => {
            ...
            const blockMatch = post.blocks?.some((b: any) => b.content.toLowerCase().includes(lowerTerm));
            return codeMatch || userMatch || blockMatch;
        });
    }, [posts, searchTerm]);

    return { searchTerm, setSearchTerm, filteredPosts, loading };
};

// 2. メインページコンポーネント
export default function SearchPage() {
    // フックから状態と関数を取得
    const { searchTerm, setSearchTerm, filteredPosts, loading } = usePostSearch();
            ...
            <main className='flex-1 md:ml-64 h-full relative pt-16 md:pt-0'>
                ...
                <div className="relative z-10 w-full h-full p-8 md:p-12 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="max-w-3xl mx-auto mb-12 mt-4">
                        <h1 className="text-4xl font-bold text-center mb-8 text-gray-900">投稿を探す</h1>
                    ...
                    <div className="max-w-6xl mx-auto pb-20">
                        {loading ? (
                            ...
                            <div className="text-center py-20 text-gray-500 bg-white/50 backdrop-blur-sm rounded-2xl border border-gray-100 border-dashed">
