                ...
                <div className="flex flex-col gap-1 pt-1 pb-2 pl-4">
                    <Link 
                        ...
                        className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-2 ${
                            currentPath === '/create' ? 'bg-blue-100 text-blue-700 font-bold shadow-sm' : 'text-gray-500 hover:text-blue-600 hover:bg-blue-200' 
                        }`}
                    >
                    ...
                    <Link 
                        href="/create/block" 
                        className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-2 ${
                            currentPath === '/create/block' ? 'bg-emerald-100 text-emerald-700 font-bold shadow-sm' : 'text-gray-500 hover:text-emerald-600 hover:bg-emerald-50' 
                        }`}
                    >
